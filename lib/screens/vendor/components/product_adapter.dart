...
class ProductAdapter extends StatelessWidget {
  ...
  ProductAdapter({this.productName, this.brandName, this.imageUrl,this.price,this.rating});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: (){
        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>AddProduct(title: 'Edit Product',)));
      },
      child: Container(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                },child: SvgPicture.asset('icons/delete.svg',height: 24,color: AppColors.TextSubdued,)),
              ],
            )
          ],
        ),
