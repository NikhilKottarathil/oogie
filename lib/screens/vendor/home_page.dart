...
class _HomePageState extends State<HomePage>
  ...
  List<Widget> _tabList = [Reports(), Products(), Orders(), Invoices(),Users()];
  List<String> _tabTitleList = ['Reports', 'Products', 'Orders', 'Invoice','Users'];
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: vendorAppBar(
            context: context, text: _tabTitleList[_currentIndex]),
        body: TabBarView(
