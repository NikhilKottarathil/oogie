...
class EditProfileBloc extends Bloc<EditProfileEvent, EditProfileState> {
  ...
  EditProfileBloc({this.profileRepository,this.profileBloc}) : super(EditProfileState()){
    setUserDetails();
  }
  setUserDetails(){
  ...
  Stream<EditProfileState> mapEventToState(EditProfileEvent event) async* {
    if (event is EditProfileUsernameChanged) {
      ...
      try {
        await profileRepository.editProfile(userName:state.userName,phoneNumber:state.phoneNumber);
