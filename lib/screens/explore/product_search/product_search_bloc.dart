...
import 'package:oogie/screens/explore/product_search/product_search_event.dart';
import 'package:oogie/screens/explore/product_search/product_search_state.dart';

class ProductSearchBloc extends Bloc<ProductSearchEvent, ProductSearchState> {
  ProductRepository productRepository;
  String parentPage;

  ProductSearchBloc({@required this.productRepository, @required this.parentPage})
