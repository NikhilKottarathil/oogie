...
class ExploreState {
  ...
  ExploreState(
      {this.advertisementModels,
      this.categoryModels,
      this.featuredProductModels,
      this.itemsInCartCount,
      this.messageCount,
      this.newArrivedProductModels,
  ...
  ExploreState copyWith({
    ...
    return ExploreState(
      ...
      selectedCategoryModel:
          selectedCategoryModel ?? this.selectedCategoryModel,
      advertisementModels: advertisementModels ?? this.advertisementModels,
      newArrivedProductModels:
          newArrivedProductModels ?? this.newArrivedProductModels,
      featuredProductModels:
          featuredProductModels ?? this.featuredProductModels,
    );
  }
}
