...
import 'package:oogie/screens/authentication/reset_password/reset_password_event.dart';
import 'package:oogie/screens/authentication/reset_password/reset_password_state.dart';
import 'package:oogie/screens/authentication/reset_password/reset_password_status.dart';
      ...
      appBar: defaultAppBarWhite(
          ...
          prefixAction: () {
            ResetPasswordStatus formStatus =
                context.read<ResetPasswordBloc>().state.formStatus;
            if (formStatus is InitialStatus ||
              ...
              context.read<ResetPasswordBloc>().add(ReverseButtonSubmitted());
            }
          }),
                                    ...
                                    text: state.formStatus is InitialStatus
                                        ...
                                        : state.formStatus
                                            ...
                                            : state.formStatus
                                                ...
                                                : 'Login',
                                    action: () {
                                      if(state.formStatus is NewPasswordSubmittedSuccessfully){
                                        Navigator.of(context).pop();
                                      }else {
