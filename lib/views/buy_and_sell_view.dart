...
class _BuyAndSellViewState extends State<BuyAndSellView> {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: (){
        Navigator.push(context, MaterialPageRoute(builder: (context)=>UsedPhonesList()));
      ...
      child: Container(
        ...
        child: Stack(
          children: [
              SvgPicture.asset('assets/buy_and_sell_background.svg',fit: BoxFit.fill,height: height*.35,  width: double.infinity,),
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(child: Center(child: Image.network('https://www.phonepro.in/assets/img/intro-mobile.png',height: height*.15,fit: BoxFit.scaleDown,)))
                ],
              ),
            ),
          ],
